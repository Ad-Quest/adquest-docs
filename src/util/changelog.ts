...
async function getWARPReleases(): Promise<Array<CollectionEntry<"changelog">>> {
	...
	return releases.map((release) => {
		...
		const link =
			track === "ga"
				? "[stable releases downloads page](/AdQuest-one/team-and-resources/devices/warp/download-warp/)"
				: "[beta releases downloads page](/AdQuest-one/team-and-resources/devices/warp/download-warp/beta-releases/)";
